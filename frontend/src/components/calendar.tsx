      ...
      <div className="overflow-x-auto">
        <div className="p-1.5 w-full inline-block align-middle">
          <div className="overflow-hidden">
            <div className=" my-2 flex flex-row justify-between flex-wrap">
              ...
              <div className="text-gray-600 ">
                <div className="rounded-full bg-blue-700 text-white text-sm px-8 py-3">{date.toLocaleString('default', { month: 'long' })}</div>
              </div>
